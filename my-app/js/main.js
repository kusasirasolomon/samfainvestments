...
function quickView(id) {
    ...
    document.getElementById("qv-price").textContent = "UGX " + Number(product.price).toLocaleString();

    document.getElementById("qv-add-cart").onclick = () => addToCart(product);

    document.getElementById("quickViewModal").style.display = "flex";

    console.log("Quick view opened:", product.name);
}
...
// IMPORTANT ONES FROM PRODUCTS PAGE
